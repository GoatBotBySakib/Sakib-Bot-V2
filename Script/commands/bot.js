...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "sakib") || (event.body.toLowerCase() == "Sakib vai") || (event.body.toLowerCase() == "@Sakib") || (event.body.toLowerCase() == "সাকিব")) {
     return api.sendMessage("উনি এখন কাজে ব্যাস্ত আছেন কি বলবেন আমাকে বলেন..!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[OWNWE:☞ ᏕᏗᏦᎥᏰ ᏰᏂᏗᎥ ☜\nYou can call him SAKIB.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://https://www.facebook.com/Sakib.bhai.4x\nতার সাথে যোগাযোগ করবেন WhatsApp :- +8801765051219", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My creator : ᏕᏗᏦᎥᏰ ᏰᏂᏗᎥ ❤️ হাই আমি মেসেঞ্জার বট, আমার বস সাকিব আমাকে বানিয়েছেন আপনাদের হাসানোর জন্য। আমি চাই আপনারা সবসময় হাসি খুশি থাকেন", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "shala ami tor boss") || (event.body.toLowerCase() == "shala ami sakib") || (event.body.toLowerCase() == "chup shala ami sakib") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Moni Moni") || (event.body.toLowerCase() == "@Moni Moni ")) {
     return api.sendMessage("খবরদার কেউ এই আইডি মেনশন দিবানা এটা আমার বস সাকিব এর বউ এর আইডি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Moni") || (event.body.toLowerCase() == "মনি")) {
     return api.sendMessage("খবরদার কেউ এই নাম ধরে ডাক দিবানা এটা আমার বস সাকিব এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "Mrittika") || (event.body.toLowerCase() == "মৃত্তিকা")) {
     return api.sendMessage("খবরদার কেউ এই নাম ধরে ডাক দিবানা এটা আমার বস সাকিব এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Suraiya") || (event.body.toLowerCase() == "সুরাইয়া")) {
     return api.sendMessage("খবরদার কেউ এই নাম ধরে ডাক দিবানা এটা আমার বস সাকিব এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "সিয়াম")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস সাকিব এর বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_> NOOB ☢️_𖣘 -BOT ⚠️ TEAM_ ☢️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "মাধু") || (event.body.toLowerCase() == "madhu")) {
   ...
   if ((event.body.toLowerCase() == "ami sakib") || (event.body.toLowerCase() == "kireee")) {
